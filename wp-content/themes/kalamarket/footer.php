                    ...
                    <div class="col-12">
                        <div class="item">
                            <span class="icon-shopping">
                                <img src="<?php echo  get_template_directory_uri() ?>/assets/images/footer/features/delivery-truck.svg" width="50" alt="تحویل اکسپرس" class="img-shopping">
                            </span>
                        ...
                        <div class="item">
                            <span class="icon-shopping">
                                <img src="<?php echo  get_template_directory_uri() ?>/assets/images/footer/features/24-hours-support.svg" width="50" alt="پشتیبانی ۲۴ ساعته" class="img-shopping">
                            </span>
                        ...
                        <div class="item">
                            <span class="icon-shopping">
                                <img src="<?php echo  get_template_directory_uri() ?>/assets/images/footer/features/income.svg" width="50" alt="پرداخت در محل" class="img-shopping">
                            </span>
                        ...
                        <div class="item">
                            <span class="icon-shopping">
                                <img src="<?php echo  get_template_directory_uri() ?>/assets/images/footer/features/easy-return.svg" width="50" alt="۷ روز ضمانت بازگشت" class="img-shopping">
                            </span>
                        ...
                        <div class="item">
                            <span class="icon-shopping">
                                <img src="<?php echo  get_template_directory_uri() ?>/assets/images/footer/features/original.svg" width="50" alt="ضمانت اصل‌بودن کالا" class="img-shopping">
                            </span>
                                                    ...
                                                    <div class="owl-item active" style="width: 300.75px; margin-left: 10px;">
                                                        <div class="item">
                                                            <a href="#" class="d-block hover-img-link">
                                                                <img src="<?php echo  get_template_directory_uri() ?>/assets/images/footer/license/L-1.png" class="img-fluid img-brand" alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="owl-item active" style="width: 300.75px; margin-left: 10px;">
                                                        <div class="item">
                                                            <a href="#" class="d-block hover-img-link mt-0">
                                                                <img src="<?php echo  get_template_directory_uri() ?>/assets/images/footer/license/L-2.png" class="img-fluid img-brand" alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <div class="P-loader">
        <div class="P-loader-content">
            ...
            <div class="pic-loader text-center">
                <img src="<?php echo  get_template_directory_uri() ?>/assets/images/three-dots.svg" width="50" alt="">
            </div>
        </div>
    </div>
    <!-- Page Loader----------------------------->
