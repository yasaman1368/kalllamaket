                ...
                <div class="owl-stage-outer">
                    <div class="owl-stage" style="transform: translate3d(1369px, 0px, 0px); transition: all 0.25s ease 0s; width: 2190px;">
                        <div class="owl-item cloned" style="width: 273.75px;">
                            <div class="item">
                                <a href="#">
                                    <img src="<?php echo  get_template_directory_uri() ?>/assets/images/slider-moment/sm-1.jpg" class="w-100" alt="">
                                </a>
                        ...
                        <div class="owl-item cloned" style="width: 273.75px;">
                            <div class="item">
                                <a href="#">
                                    <img src="<?php echo  get_template_directory_uri() ?>/assets/images/slider-moment/sm-2.jpg" class="w-100" alt="">
                                </a>
                                <h3 class="product-title">
                        ...
                        <div class="owl-item" style="width: 273.75px;">
                            <div class="item">
                                <a href="#">
                                    <img src="<?php echo  get_template_directory_uri() ?>/assets/images/slider-moment/sm-3.jpg" class="w-100" alt="">
                                </a>
                                <h3 class="product-title">
                        ...
                        <div class="owl-item" style="width: 273.75px;">
                            <div class="item">
                                <a href="#">
                                    <img src="<?php echo  get_template_directory_uri() ?>/assets/images/slider-moment/sm-4.jpg" class="w-100" alt="">
                                </a>
                                <h3 class="product-title">
                        ...
                        <div class="owl-item" style="width: 273.75px;">
                            <div class="item">
                                <a href="#">
                                    <img src="<?php echo  get_template_directory_uri() ?>/assets/images/slider-moment/sm-5.jpg" class="w-100" alt="">
                                </a>
                                <h3 class="product-title">
