                ...
                <div class="owl-stage-outer">
                    <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1162px;">
                        <div class="owl-item tab-item active" style="width: 222.313px; margin-left: 10px;">
                            <div class="item">
                                <a href="#" class="d-block hover-img-link">
                                    <img src="<?php echo  get_template_directory_uri() ?>/assets/images/slider-amazing/as-1.jpg" class="img-fluid" alt="">
                                </a>
                                <h2 class="post-title">
                                    <a href="#">
                                ...
                                <div class="countdown-timer">
                                    <div class="countdown h4" data-date-time="10/10/2025 12:00" data-labels="{&quot;label-day&quot;: &quot;روز&quot;, &quot;label-hour&quot;: &quot;ساعت&quot;, &quot;label-minute&quot;: &quot;دقیقه&quot;, &quot;label-second&quot;: &quot;ثانیه&quot;}">
                        ...
                        <div class="owl-item tab-item active" style="width: 222.313px; margin-left: 10px;">
                            <div class="item">
                                <a href="#" class="d-block hover-img-link">
                                    <img src="<?php echo  get_template_directory_uri() ?>/assets/images/slider-amazing/as-2.jpg" class="img-fluid" alt="">
                                </a>
                                <h2 class="post-title">
                                    <a href="#">
                        ...
                        <div class="owl-item tab-item active" style="width: 222.313px; margin-left: 10px;">
                            <div class="item">
                                <a href="#" class="d-block hover-img-link">
                                    <img src="<?php echo  get_template_directory_uri() ?>/assets/images/slider-amazing/as-3.jpg" class="img-fluid" alt="">
                                </a>
                                <h2 class="post-title">
                                    <a href="#">
                        ...
                        <div class="owl-item tab-item active" style="width: 222.313px; margin-left: 10px;">
                            <div class="item">
                                <a href="#" class="d-block hover-img-link">
                                    <img src="<?php echo  get_template_directory_uri() ?>/assets/images/slider-amazing/as-4.jpg" class="img-fluid" alt="">
                                </a>
                                <h2 class="post-title">
                                    <a href="#">
                        ...
                        <div class="owl-item tab-item" style="width: 222.313px; margin-left: 10px;">
                            <div class="item">
                                <a href="#" class="d-block hover-img-link">
                                    <img src="<?php echo  get_template_directory_uri() ?>/assets/images/slider-amazing/as-5.jpg" class="img-fluid" alt="">
                                </a>
                                <h2 class="post-title">
                                    <a href="#">
            ...
            <div class="row m-0">
                <ol class="carousel-indicators pr-0">
                    <li class="active" data-target="#amazing-slider" data-slide-to="0">
                        <img src="<?php echo  get_template_directory_uri() ?>/assets/images/slider-amazing/as-1.jpg" class="img-fluid">
                    </li>
                    <li data-target="#amazing-slider" data-slide-to="1" class="">
                        <img src="<?php echo  get_template_directory_uri() ?>/assets/images/slider-amazing/as-2.jpg" class="img-fluid">
                    </li>
                    <li data-target="#amazing-slider" data-slide-to="2" class="">
                        <img src="<?php echo  get_template_directory_uri() ?>/assets/images/slider-amazing/as-3.jpg" class="img-fluid">
                    </li>
                    <li data-target="#amazing-slider" data-slide-to="3" class="">
                        <img src="<?php echo  get_template_directory_uri() ?>/assets/images/slider-amazing/as-4.jpg" class="img-fluid">
                    </li>
                    <li data-target="#amazing-slider" data-slide-to="4" class="">
                        <img src="<?php echo  get_template_directory_uri() ?>/assets/images/slider-amazing/as-5.jpg" class="img-fluid">
                    </li>
